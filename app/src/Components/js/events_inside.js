...
import '../stylesheets/events_inside.css';
    ...
    <div>
      <main>
            ...
            <div className="sidebar-items">
              <a href="#" onMouseOver={() => showContent('tessaract')}>
                <div className="sidebar-item">
                  <img src={img1} alt="TESSARACT 2.0" className="sidebar-icon" />
                  <h2>TESSARACT 2.0</h2>
                </div>
              </a>
              ...
              <a href="#" onMouseOver={() => showContent('simulatemoon')}>
                <div className="sidebar-item">
                  <img src={img1} alt="SIMULATE TO THE MOON" className="sidebar-icon" />
        ...
        <section className="main-content">
          <div id="tessaract" className={`content-section ${activeSection === 'tessaract' ? 'active' : ''}`}>
            <div className="event-details">
              <h1>TESSARACT 2.0</h1>
              <p className='date'>Date: 16/1/2024 - 31/1/2024</p>
              <p className='description'>An online game development competition where participants showcase their creative skills in developing games using a Godot Engine.</p>
              <div className='buttons svelte-12ryxuf'>
              <a href="#rules" class="a-unset register svelte-12ryxuf">LEARN MORE</a>
              <a class="a-unset register svelte-12ryxuf">Registrations Closed</a>
            </div>
            </div>
            ...
            <div className='judging_criteria'>
              ...
              <p className='description'>
              Any malpractices won't be entertained and will lead to instant disqualification. Any round specific rules will be conveyed before the event starts              </p>
            </div>
          ...
          <div id="gameforge" className={`content-section ${activeSection === 'gameforge' ? 'active' : ''}`}>
            <div className="event-details">
              <h1>GAME FORGE</h1>
              <p className='date'>Date: 16/1/2024 - 31/1/2024</p>
              <p className='description'>An online game development competition where participants showcase their creative skills in developing games using a Godot Engine.</p>
          ...
          <div id="algotrek" className={`content-section ${activeSection === 'algotrek' ? 'active' : ''}`}>
            <div className="event-details">
              <h1>ALGOTREK</h1>
              <p className='date'>Date: 16/1/2024 - 31/1/2024</p>
              <p className='description'>An online game development competition where participants showcase their creative skills in developing games using a Godot Engine.</p>
          ...
          <div id="simulatemoon" className={`content-section ${activeSection === 'simulatemoon' ? 'active' : ''}`}>
            <div className="event-details">
          ...
          <div id="webmosiac" className={`content-section ${activeSection === 'webmosiac' ? 'active' : ''}`}>
            <div className="event-details">
              <h1>WEBMOSIAC</h1>
              <p className='date'>Date: 16/1/2024 - 31/1/2024</p>
              <p className='description'>An online game development competition where participants showcase their creative skills in developing games using a Godot Engine.</p>
